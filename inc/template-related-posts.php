 ...
 * @return array
 */
function cherry_related_posts() {

	if ( ! is_singular( 'post' ) ) {
		return;
	}

	$visible = get_theme_mod( 'related_posts_visible', cherry_theme()->customizer->get_default( 'related_posts_visible' ) );
	...
	$post_terms  = '';
	$post_number = get_theme_mod( 'related_posts_count', cherry_theme()->customizer->get_default( 'related_posts_count' ) );
	...
	$utility         = cherry_utility()->utility;
	...
	foreach ( $settings as $setting_key => $setting_value ) {
		$settings[ $setting_key ] = get_theme_mod( $setting_value, cherry_theme()->customizer->get_default( $setting_value ) );
	}

	$settings['title_visible']   = $settings[ 'title_length' ] ? get_theme_mod( 'related_posts_title', cherry_theme()->customizer->get_default( 'related_posts_title' ) ) : false;
