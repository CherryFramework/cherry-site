 ...
 * @return void
 */
function cherry_menu_toggle( $menu_id ) {
?>
 ...
 * @return void
 */
function cherry_main_menu() { ?>
	<nav id="site-navigation" class="main-navigation" role="navigation">
		<?php
			$args = apply_filters( 'cherry_main_menu_args', array(
				'theme_location'   => 'main',
				'container'        => '',
				'menu_id'          => 'main-menu',
				'fallback_cb'      => 'cherry_set_nav_menu',
				'fallback_message' => esc_html__( 'Set main menu', 'cherry' ),
			) );
...
function cherry_footer_menu() { ?>
	...
	<?php
		$args = apply_filters( 'cherry_footer_menu_args', array(
			...
			'fallback_message' => esc_html__( 'Set footer menu', 'cherry' ),
		) );
 ...
 * @return string
 */
function cherry_get_social_list( $context, $type = 'icon' ) {
	static $instance = 0;
	$instance++;
	...
	$args = apply_filters( 'cherry_social_list_args', array(
		...
		'echo'             => false,
		'fallback_cb'      => 'cherry_set_nav_menu',
		'fallback_message' => esc_html__( 'Set social menu', 'cherry' ),
	), $context, $type );
 ...
 * @return void
 */
function cherry_set_nav_menu( $args ) {
