...
if ( ! class_exists( 'Cherry_Contact_Information_Widget' ) ) {

	class Cherry_Contact_Information_Widget extends Cherry_Abstract_Widget {
		...
		public function __construct() {
			...
			$this->widget_description = esc_html__( 'Display an contact-information.', 'cherry' );
			$this->widget_id          = 'cherry_contact_information_widget';
			$this->widget_name        = esc_html__( 'Contact Information', 'cherry' );
			...
			$this->settings = array(
				...
				'contact_information'  => array(
					'type'         => 'repeater',
					'add_label'    => esc_html__( 'Add Contact Information', 'cherry' ),
					'title_field'  => 'value',
					'hidden_input' => true,
					'fields'       => array(
						'icon' => array(
							...
							'id'          => 'icon',
							'name'        => 'icon',
							'label'       => esc_html__( 'Choose icon', 'cherry' ),
							'icon_data'   => array(
								'icon_set'    => 'cherryWidgetFontAwesome',
								'icon_css'    => CHERRY_THEME_CSS . '/font-awesome.min.css',
								'icon_base'   => 'fa',
								'icon_prefix' => 'fa-',
						...
						'value' => array(
							...
							'id'          => 'value',
							'name'        => 'value',
							'placeholder' => esc_html__( 'Value', 'cherry' ),
							'label'       => esc_html__( 'Value', 'cherry' ),
						),
					),
				),
			);
...
add_action( 'widgets_init', 'cherry_register_contact_information_widget' );
function cherry_register_contact_information_widget() {
	register_widget( 'Cherry_Contact_Information_Widget' );
}
