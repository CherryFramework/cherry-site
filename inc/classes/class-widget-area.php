...
if ( ! class_exists( 'Cherry_Widget_Area' ) ) {

	class Cherry_Widget_Area {
		...
		function __construct() {
			...
			add_action( 'cherry_render_widget_area', array( $this, 'render' ) );
		}
		...
		public function render( $area_id ) {
			...
			$area_id        = apply_filters( 'cherry_rendering_current_widget_area', $area_id );
			...
			$classes = apply_filters( 'cherry_widget_area_classes', $classes, $area_id );
	...
	function cherry_widget_area() {
		return Cherry_Widget_Area::get_instance();
	}
